class Promise < ApplicationRecord
  ...
  validate :week_ids_selected, on: [:create, :update], if: -> { select_type == "曜日を指定して登録する" }
  ...
  def week_ids=(ids)
    ...
    Rails.logger.debug "After assignment, weeks: #{self.weeks.inspect}"
  end
